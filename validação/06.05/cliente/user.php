...
<?php include ('header.php'); ?>
    ...
    $select2 = "  SELECT  clini.nm_unidade, clini.estado, clini.cidade, clini.bairro, clini.rua, clini.nr_end, clini.cep, clini.imagem, vet.nm_vet, e.especialidade 
	FROM tb_clinica as clini 
		INNER JOIN tb_veterinario as vet ON clini.id = vet.clinica_id 
            INNER JOIN tb_especialidade as e ON vet.especialidade = e.id;";
        ...
        // Executar a consulta
            ...
            while($dados2 = $result2->fetch_array()){
                ...
                $cepc = $dados2['cep'];
                $nm_vetc = $dados2['nm_vet'];
                $especialidadec = $dados2['especialidade'];
                $card = "
                <div class='col-lg-6'>
                    <div class='card shadow mb-4'>
                        ...
                        <div class='card-body'>
                            <p>Nome do veterinário: $nm_vetc</p>
                            <p>Especialidade: $especialidadec</p>
