...
CREATE TABLE `tb_clinica` (
  ...
  KEY `tb_clinica_ibfk_2_idx` (`id_veterinario`),
  CONSTRAINT `tb_clinica_ibfk_1` FOREIGN KEY (`login_id`) REFERENCES `tb_login` (`id`),
  CONSTRAINT `tb_clinica_ibfk_2` FOREIGN KEY (`id_veterinario`) REFERENCES `tb_veterinario` (`id`)
...
-- Dump completed on 2024-04-20  1:28:08
