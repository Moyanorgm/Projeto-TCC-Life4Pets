    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="planos.php">Planos</a></li>
          <li><a class="nav-link scrollto" href="#team">Equipe</a></li>

          <li class="dropdown"><a href="#"><span>Conta</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li class="dropdown left-dropdown">
                <a href="#"><span>Clínica</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="clinica/login.php">Login</a></li>
                  <li><a href="clinica/register.php">Cadastre-se</a></li>
                </ul>
              </li>
              <li class="dropdown left-dropdown">
                <a href="#"><span>Cliente</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="cliente/login.php">Login</a></li>
                  <li><a href="cliente/register.php">Cadastre-se</a></li>
                </ul>
              </li>
            </ul>
          </li>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up">
              <div class="member-img">
                <img src="assets\img\peterson.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="assets\img\felipe.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="assets\img\rogerio.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
