...
try {
    ...
    $sql_clinica = "INSERT INTO tb_clinica (nm_unidade, cnpj, login_clinica, cep, estado, cidade, bairro, rua, nr_end, celular, imagem) VALUES ('$nm_unidade', '$cnpj', '$login_clinica', '$cep', '$estado', '$cidade', '$bairro', '$rua', '$nr_end', '$celular', '$imagem')";
    $mysqli->query($sql_clinica);
    // Confirmar a transação
    $mysqli->commit();
