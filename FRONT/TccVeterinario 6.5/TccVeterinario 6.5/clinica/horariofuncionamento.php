...
<head>
    ...
    <title>Cadastro de Horários de Funcionamento</title>
</head>
<body>
    <h2>Cadastro de Horários de Funcionamento</h2>
    <form action="" method="post">
        <label for="segunda">Segunda-feira:</label>
        <input type="time" id="segunda" name="segunda_abertura"> - 
        <input type="time" id="segunda" name="segunda_fechamento"><br>

        <label for="terca">Terça-feira:</label>
        <input type="time" id="terca" name="terca_abertura"> - 
        <input type="time" id="terca" name="terca_fechamento"><br>

        <label for="quarta">Quarta-feira:</label>
        <input type="time" id="quarta" name="quarta_abertura"> - 
        <input type="time" id="quarta" name="quarta_fechamento"><br>

        <label for="quinta">Quinta-feira:</label>
        <input type="time" id="quinta" name="quinta_abertura"> - 
        <input type="time" id="quinta" name="quinta_fechamento"><br>

        <label for="sexta">Sexta-feira:</label>
        <input type="time" id="sexta" name="sexta_abertura"> - 
        <input type="time" id="sexta" name="sexta_fechamento"><br>

        <label for="sabado">Sábado:</label>
        <input type="time" id="sabado" name="sabado_abertura"> - 
        <input type="time" id="sabado" name="sabado_fechamento"><br>

        <label for="domingo">Domingo:</label>
        <input type="time" id="domingo" name="domingo_abertura"> - 
        <input type="time" id="domingo" name="domingo_fechamento"><br>
    ...
    $clinica_id = $id ;
        ...
        function inserirHorario($mysqli, $clinica_id, $dia, $abertura, $fechamento) {
            $sql = "INSERT INTO tb_horarios_funcionamento (clinica_id, dia_semana, hora_abertura, hora_fechamento)
            VALUES ('$clinica_id','$dia', '$abertura', '$fechamento')";

            if ($mysqli->query($sql) !== TRUE) {
                echo "Erro ao cadastrar os horários para $dia: " . $mysqli->error;
            }
        }

        // Recebe os dados do formulário e insere no banco de dados
        inserirHorario($mysqli, $clinica_id, "segunda", $_POST['segunda_abertura'], $_POST['segunda_fechamento']);
         inserirHorario($mysqli, $clinica_id, "terca", $_POST['terca_abertura'], $_POST['terca_fechamento']);
        inserirHorario($mysqli, $clinica_id, "quarta", $_POST['quarta_abertura'], $_POST['quarta_fechamento']);
        inserirHorario($mysqli, $clinica_id, "quinta", $_POST['quinta_abertura'], $_POST['quinta_fechamento']);
        inserirHorario($mysqli, $clinica_id, "sexta", $_POST['sexta_abertura'], $_POST['sexta_fechamento']);
        inserirHorario($mysqli, $clinica_id, "sabado", $_POST['sabado_abertura'], $_POST['sabado_fechamento']);
        inserirHorario($mysqli, $clinica_id, "domingo", $_POST['domingo_abertura'], $_POST['domingo_fechamento']);
