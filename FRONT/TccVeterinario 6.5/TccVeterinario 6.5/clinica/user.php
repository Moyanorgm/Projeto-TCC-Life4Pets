...
include ('header.php'); 
$select5 = "select count(c.id) FROM tb_consulta as c WHERE cliente_id = '14';";
$resultado5 = $mysqli->query($select5);
                                            if ($resultado5->num_rows > 0) {
                                                while ($dados3 = $resultado5->fetch_array()) {

                                                    $cont = $dados3['count(c.id)'];
                                                    echo $cont;
                                                }}
echo $imagem;
?>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0e213b;  padding-top: 1rem;">
            ...
            <div id="content">
                ...
                <div class="container-fluid d-flex align-items-center justify-content-center"
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800"><?php echo $cont; ?>  Consultas Foram Agendadas</p>
                    </div>
