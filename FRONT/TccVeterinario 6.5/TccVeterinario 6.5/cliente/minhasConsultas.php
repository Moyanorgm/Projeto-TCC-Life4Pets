                    ...
                    <h1 class="h3 mb-2 text-gray-800">Minhas Consultas</h1>
                        ...
                        <?php 
                            ...
                            $cliente_id = $id;
                                ...
                                $select3 = "SELECT cons.status, cons.hr_consulta, cons.dt_consulta, cons.ds_consulta, cons.ds_medicacao, cons.tipo_exame, cli.nm_responsavel, p.nm_animal, clini.nm_unidade
